...
namespace System.CommandLine.Rendering.Tests
{
    ...
    public class AnsiTests
    {
        ...
        {
            Ansi.Cursor.Move.Down()
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[1B");
            Ansi.Cursor.Move.Down(5)
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[5B");
        }
        ...
        {
            Ansi.Cursor.Move.Right()
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[1C");
            Ansi.Cursor.Move.Right(5)
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[5C");
        }
        ...
        {
            Ansi.Cursor.Move.Left()
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[1D");
            Ansi.Cursor.Move.Left(5)
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[5D");
        }
        ...
        public void Ansi_cursor_move_to_location_returns_correct_terminal_sequence()
        {
            Ansi.Cursor.Move.ToLocation()
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[1;1H");
            Ansi.Cursor.Move.ToLocation(3)
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[1;3H");
            Ansi.Cursor.Move.ToLocation(top: 2)
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[2;1H");
            Ansi.Cursor.Move.ToLocation(5, 4)
                .EscapeSequence.Should()
                .Be($"{Ansi.Esc}[4;5H");
        }

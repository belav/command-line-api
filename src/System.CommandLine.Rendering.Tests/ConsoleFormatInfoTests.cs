...
namespace System.CommandLine.Rendering.Tests
{
    public class ConsoleFormatInfoTests
    {
        ...
        public void GetInstance_null_returns_current()
        {
            ...
            info.Should().BeSameAs(ConsoleFormatInfo.CurrentInfo);
        }
        ...
        {
            var info = new ConsoleFormatInfo();
            info.GetFormat(typeof(ConsoleFormatInfo)).Should().BeSameAs(info);
        }
        ...
        {
            var info = new ConsoleFormatInfo();
            info.GetFormat(typeof(NumberFormatInfo)).Should().BeNull();
        }
    }
}
